...
var qustionarray=["click on the red brick","click on the blue brick","click on the green brick","click on the purple brick","click on the yellow brick"]
var randomQuestion 
var gamestate="start" 
var flag=0
...
function generateRandomQuestion(){
   if(randomQuestion===0&&mo1.visible===false&&flag===1){
    text(qustionarray[0],400,400)
  }
  else{
    if(randomQuestion===1&&mo2.visible===false&&flag===1){
    text(qustionarray[1],400,400)
  }
  else{
    console.log(randomQuestion)
    console.log(flag)
    console.log("mo2"+mo2.visible)
    console.log("mo1"+mo1.visible)
    text("try again",400,400)
    button.show()
  }
  }
}
function colourexection() {
